...
# The following code transforms the Date and Time vars from characters into objects of type Date and POSIXlt respectively
...
# The following code initiates a composite plot with many graphs
par(mfrow=c(2,2))

# The following code calls the basic plot function that calls different plot functions to build the 4 plots that form the graph
with(subpower,{
